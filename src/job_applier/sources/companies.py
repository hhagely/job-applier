...
# Workable boards. Slugs are lowercased kebab-case account identifiers used in
# the apply.workable.com URL path. Originally discovered from the SimplifyJobs
# feed and verified against the live API at seed time.
...
# SmartRecruiters boards. Slugs are case-sensitive company identifiers (e.g.
# "Visa", "AveryDennison") used in the public posting API URL. Originally
# discovered from the SimplifyJobs feed and verified live at seed time.
SMARTRECRUITERS_COMPANIES: list[str] = [
    "360ITProfessionals1",
    "3SBusinessCorporationInc1",
    "4DSCorp",
    "AECOM2",
    "AJBell1",
    "ASOS",
    ...
    "MattelInc",
    "Mindlance2",
    "MiracleSoftwareSystem1",
    "MyriadGenetics1",
    "NBCUniversal3",
    "NECSWS",
    "Nexthink",
    "NielsenIQ",
    "NorthStarStaffingSolutions1",
    "NorthwesternMutual",
    "PAConsulting",
    "PioneerDataSystemsInc",
    "ProcomConsultantsGroup",
    "ProcomServices",
    "Prosum2",
    "ProximateTechnologiesInc1",
    "Quantix",
    "RA2",
    "RESPECInc",
    "RRDonnelley",
    "RadiantInfoSystemsLtd",
    "RadiusLimited",
    "Ramboll3",
    "Randstad4",
    "RedBull",
    ...
    "SQexpetsLLC",
    "STCU1",
    "SajixSoftwareSolutionPrivateLimited",
    "Sandisk",
    "SaxonGlobal",
    "Schrder",
    "ServiceNow",
    ...
    "TecTammina",
    "TestingXperts",
    "TexasWaterDevelopmentBoardTWDB",
    "TheNielsenCompany",
    "TheWonderfulCompany",
    "TreehouseStrategyAndCommunicatio",
    "TruvenHealthAnalyticsanIBMCompany",
    "TurnerTownsend",
    "UAPInc",
    "USITSolutionsInc",
    "USM2",
